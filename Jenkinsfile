pipeline {
    ...
    stages {
        ...
        stage('Neo') { 
         ...
         stage('Neo Deploy') { 
          steps {
                sh "/home/ubuntu/neo/tools/neo.sh  deploy:restart  --host https://hanatrial.ondemand.com --account  p2002559018trial --user P2002559018 -p aravind@SAP7717 --application firstapp --source  /var/lib/jenkins/workspace/sap-maven/target/java-tomcat-maven-example.war "
