    ...
    stages {
        ...
        stage('Neo Delete') { 
          steps {
                ...
                sh "/home/ubuntu/neo/tools/neo.sh  destroy  --host https://hanatrial.ondemand.com --account  p2002559018trial --user P2002559018 -p aravind@SAP7717 --application firstapp"
          }
        }
         stage('Neo Deploy') { 
          steps {
